...
extern "C" {
    #[link_name = "\u{1}_Z15craft_axe_bladev"]
    pub fn craft_axe_blade() -> *mut InventoryElement;
}
extern "C" {
    #[link_name = "\u{1}_Z16craft_axe_handlev"]
    pub fn craft_axe_handle() -> *mut InventoryElement;
}
extern "C" {
    #[link_name = "\u{1}_Z9craft_axev"]
    pub fn craft_axe() -> *mut InventoryElement;
}
extern "C" {
    #[link_name = "\u{1}_Z17craft_knife_bladev"]
    pub fn craft_knife_blade() -> *mut InventoryElement;
}
extern "C" {
    #[link_name = "\u{1}_Z18craft_knife_handlev"]
    pub fn craft_knife_handle() -> *mut InventoryElement;
}
extern "C" {
    #[link_name = "\u{1}_Z11craft_knifev"]
    pub fn craft_knife() -> *mut InventoryElement;
}
extern "C" {
...
pub struct chunk {
    ...
    pub items: [*mut InventoryElement; 256usize],
    pub beings: [*mut Being; 256usize],
    pub plants: [*mut Plant; 256usize],
    pub animals: [*mut Animal; 256usize],
    pub objects: [*mut Object; 256usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of chunk"][::std::mem::size_of::<chunk>() - 11272usize];
    ...
    ["Offset of field: chunk::items"][::std::mem::offset_of!(chunk, items) - 1032usize];
    ["Offset of field: chunk::beings"][::std::mem::offset_of!(chunk, beings) - 3080usize];
    ["Offset of field: chunk::plants"][::std::mem::offset_of!(chunk, plants) - 5128usize];
    ["Offset of field: chunk::animals"][::std::mem::offset_of!(chunk, animals) - 7176usize];
    ["Offset of field: chunk::objects"][::std::mem::offset_of!(chunk, objects) - 9224usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct timex {
...
extern "C" {
    ...
    pub fn get_item_at_ppos(player: *mut Player) -> *mut *mut InventoryElement;
}
extern "C" {
